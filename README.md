Hotel Management System — Reservation & Services Database (DBMS Project)

This repository contains the DBMS Course Project implemented using MySQL.

The project models a comprehensive hotel ecosystem and focuses on guests, room reservations, gym memberships, spa services, cab bookings, and dining operations.
